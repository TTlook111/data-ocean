...
final class IamS1EndpointExemptions {
    ...
    static final Map<String, String> EXEMPTIONS = Map.ofEntries(
            ...
            Map.entry("DELETE /api/admin/permissions/{id}, /api/permissions/{id}", "PermissionController#delete|旧权限配置链路，待 B6 删除"),
            Map.entry("DELETE /api/admin/roles/{roleId}, /api/roles/{roleId}", "RoleController#deleteRole|旧权限配置链路，待 B6 删除"),
            Map.entry("DELETE /api/admin/roles/{roleId}/users/{userId}, /api/roles/{roleId}/users/{userId}", "RoleController#removeRoleFromUser|旧权限配置链路，待 B6 删除"),
            ...
            Map.entry("GET /api/admin/permissions, /api/permissions", "PermissionController#list|旧权限配置链路，待 B6 删除"),
            Map.entry("GET /api/admin/permissions/tree, /api/permissions/tree", "PermissionController#tree|旧权限配置链路，待 B6 删除"),
            Map.entry("GET /api/admin/roles, /api/roles", "RoleController#listRoles|旧权限配置链路，待 B6 删除"),
            Map.entry("GET /api/admin/roles/{roleId}/permissions, /api/roles/{roleId}/permissions", "RoleController#listRolePermissions|旧权限配置链路，待 B6 删除"),
            Map.entry("GET /api/admin/roles/{roleId}/users, /api/roles/{roleId}/users", "RoleController#listRoleUsers|旧权限配置链路，待 B6 删除"),
            ...
            Map.entry("POST /api/admin/permissions, /api/permissions", "PermissionController#create|旧权限配置链路，待 B6 删除"),
            Map.entry("POST /api/admin/roles, /api/roles", "RoleController#createRole|旧权限配置链路，待 B6 删除"),
            Map.entry("POST /api/admin/roles/{roleId}/users, /api/roles/{roleId}/users", "RoleController#assignRoleToUser|旧权限配置链路，待 B6 删除"),
            ...
            Map.entry("PUT /api/admin/permissions/{id}, /api/permissions/{id}", "PermissionController#update|旧权限配置链路，待 B6 删除"),
            Map.entry("PUT /api/admin/roles/{roleId}, /api/roles/{roleId}", "RoleController#updateRole|旧权限配置链路，待 B6 删除"),
            Map.entry("PUT /api/admin/roles/{roleId}/permissions, /api/roles/{roleId}/permissions", "RoleController#updateRolePermissions|旧权限配置链路，待 B6 删除"),
