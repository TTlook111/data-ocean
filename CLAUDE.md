...
| Java user/auth/permission modules | Legacy implementation remains for pre-switch operation; IAM-SIMPLE-1 B1 is committed/pushed and B2/B3 S1 code is implemented but not switched |
...
- `V56` adds B3 S1 query execution evidence, safe resource/source/capability summaries, revision/snapshot identifiers, and final protection status; code is uncommitted and this migration has not been executed against real MySQL.
