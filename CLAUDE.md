...
│   ├── 后续开发.md                  # 仅列下一步执行队列
│   ├── 轨道B-B0权限清单与决策冻结.md # B0 权限清单和决策基线（已评审，B1 未开始）
