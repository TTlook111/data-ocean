...
- `V56` adds B3 S1 query execution evidence, safe resource/source/capability summaries, revision/snapshot identifiers, and final protection status; committed with B3 (`d9a0c3b`) and this migration has not been executed against real MySQL.
