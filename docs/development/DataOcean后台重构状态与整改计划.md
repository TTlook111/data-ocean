...
| Java 单元测试 | B4 最新基线 **557** 通过；B5 准备轮复跑为 **563** 通过、0 失败、0 错误；2026-09-25 对 `5f13efd` 复跑为 **581**；内部令牌加固后为 **597** 通过、0 失败、0 错误、0 跳过（新增 `InternalTokenValidatorTest` 10 个、`InternalTokenFilterTest` 6 个） | 否 |
